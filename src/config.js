...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/buynow",name:"Buy now",view:<Buynow/>},
...
const APP_LINKS = {
    messages: "http://localhost/ice_cream_2/public/message.php",
    register: "register.php",
    users: "http://localhost/ice_cream_2/public/user.php"
};
